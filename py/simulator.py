...
parser.add_argument('--file', type=argparse.FileType('r'), help='Path to a YAML file')
parser.add_argument('--mod_file', default=None)
...
def create_data(mode, t, p_type, p_bit, signed, a=10, f=0.5):
    if mode == "Word":
        ...
        return (pattern * ((p_byte // len(pattern)) + 1))[:p_byte]
    elif mode == "Wave":
